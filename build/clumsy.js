    ...
    onResetEvent: function() {
        ...
        me.game.world.addChild(new (me.Renderable.extend ({
            ...
            init: function() {
                    ...
                    this.font = new me.Font('gamefont', 20, '#d3d3d3');
            },
            update: function () {
                    return true;
            },
	...
	/* ***AGAIN BUTTON***	 var gImage1 = me.loader.getImage('again');
        ...
        this.dialog = new (me.Renderable.extend({
            ...
            init: function() {
                ...
                // renderable
                this.parent(new me.Vector2d(), 100, 100);
                this.font = new me.Font('gamefont', 40, '#000', 'left');
            ...
            draw: function (context) {
                ...
                this.font.draw(
                    context,
                    this.replayMessage1,
                    me.game.viewport.width/2 - replayText1.width/2 - 5,
                    me.game.viewport.height/2 + 92
                );
                ...
                this.font.draw(
                    context,
                    this.replayMessage2,
                    me.game.viewport.width/2 - replayText2.width/2 - 5,
                    me.game.viewport.height/2 + 126
                );
